...
import 'package:ninjaid/Family/final2.dart';


class family8 extends StatefulWidget {
  @override
  _familyState8 createState() => _familyState8();
}


class _familyState8 extends State<family8> {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Container(
                  child: Text('يجب علينا  ____  الوالدين',
                      textDirection: TextDirection.rtl,
                      textAlign: TextAlign.justify,
