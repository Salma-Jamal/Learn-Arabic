...
class kaf extends StatefulWidget {

  @override
  _kafState createState() => _kafState();
}


class _kafState extends State<kaf> {
                ...
                ButtonTheme(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          scale: 5.0,
                          image: AssetImage('assets/kangaroo.jpg'),
