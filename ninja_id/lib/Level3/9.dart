...
import 'package:ninjaid/Level3/final.dart';
import 'package:ninjaid/globals.dart' as globals;

class three10 extends StatefulWidget {
  @override
  _three10State createState() => _three10State();
}


class _three10State extends State<three10> {
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          scale: 4.0,
                          image: AssetImage('assets/square.gif'),
                  ...
                  child: Container(
                      child:MaterialButton(
                        ...
                        onPressed: () {
                          ...
                          if(globals.finishedlvl3 == false){
                            globals.calcScore(20);
                            globals.finishedlvl3 = true;
                          }
                          setState(() {
                            tcVisibility2 = true;
                          });
