...
class lam extends StatefulWidget {

  @override
  _lamState createState() => _lamState();
}


class _lamState extends State<lam> {
                ...
                ButtonTheme(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          scale: 9.0,
                          image: AssetImage('assets/pearl.jpg'),
