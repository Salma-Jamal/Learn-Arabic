...
class school9 extends StatefulWidget {
  @override
  _schoolState9 createState() => _schoolState9();
}


class _schoolState9 extends State<school9> {
          ...
          children: [
            ...
            Row(
              children: [
                SizedBox(width: 80.0),
                Container(
                  child: Text('هل يمكنك  _____  في حل الواجب المنزلي',
                      textDirection: TextDirection.rtl,
                      textAlign: TextAlign.justify,
